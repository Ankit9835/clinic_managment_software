            ...
            <div class="card">
              ...
              <div class="card-header" >
                ...
                <div class="card-body">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            @if(!App\Models\Prescription::where('date', date('Y-m-d'))->where('doctor_id', auth()->user()->id)->where('user_id', $booking->id))->exists()
                   ...
                   <a href = "{{ url('view-prescription/'.$booking->user_id. '/' . $booking->date) }}" class="btn btn-dark"> View Prescription </a>
